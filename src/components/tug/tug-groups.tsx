...
/**
 * Read-only view of the three tug-of-war pools with round-win standings.
 * Rank 1 (group winner) and rank 2 (wildcard contender) are highlighted so
 * viewers can see who is advancing. Shared by /tug-of-war and /teams.
 */
export function TugGroups({
  teams,
  tug,
}: {
  teams: RosterTeam[];
  ...
  const standings = computeGroupStandings(tug.groupMembers, tug.matches, teams);
