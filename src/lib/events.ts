...
export const teamEvents: EventRule[] = [
  {
    ...
    icon: ShieldAlert,
    color: "#F43F5E",
    participants: "Full team (6 players per team)",
    equipment: [
    ...
    rules: [
      ...
      "Players 2 through 6 in line each have a towel clipped onto the back of their shirt so it visibly sticks out",
  ...
  },
  {
    ...
    equipment: [
      ...
      "Leg markers",
      "Lane cones",
      "Condition-specific gear (provided on the day)",
    ],
    rules: [
      "Each leg of the race is 35m and comes with a specific condition that must be met in full",
      "Players line up at opposite ends of the boundary lines — complete your leg, then tag your teammate waiting at the other side to send them off",
      "The next runner can only start once the previous player has passed the boundary line",
      "A whistle will signal the start of the race",
      "Failure to meet a leg's condition means the team must repeat that leg",
      "The team's time is recorded when the final runner crosses the finish line",
    ],
    setup: [
