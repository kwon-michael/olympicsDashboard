 ...
 * 3rd-place match. Shared by the Tug of War and Dodgeball views. Shows "TBD"
 * slots until participants are seeded and results recorded.
 */
export function TournamentBracket({
  ...
  const { semis, final, third } = bracketMatches(data.matches);
